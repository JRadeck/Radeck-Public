...
start-process 'c:\Windows\System32\msiexec.exe' -ArgumentList "/i CRRuntime_12_2_mlb.msi /QB! REBOOT=ReallySuppress /l*v $env:WINDIR\Temp\Install-CrystalReports2008RuntimeSP2.log" -wait -Verbose
}
Else{
